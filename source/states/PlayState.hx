...
import level.objects.GloopPlayer;
...
class PlayState extends FlxState {
    ...
    override public function create() {
        ...
        else if (levelLoader.loadedLevelData.objects.player.type == "gloop")
            playerCharacter = new GloopPlayer(levelLoader.loadedLevelData.objects.player.x, levelLoader.loadedLevelData.objects.player.y);
        else
